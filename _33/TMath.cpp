...
Vector3 Vector3::operator * (TMatrix& m)
{
	Vector3 v;
...
void TMatrix::Scale(const Vector3& v) 
{
...
void TMatrix::Rotate(Vector3 Rotation)
{
	TMatrix x;
	x.XRotate(Rotation.x);
	TMatrix y;
	y.YRotate(Rotation.y);
	TMatrix z ;
	z.ZRotate(Rotation.z);

	*this = *this* x* y* z;
}
void TMatrix::Translation(const Vector3& v)
{
...
TMatrix TMatrix::ViewMatrix(Vector3& pos,
	Vector3& target,
	Vector3& up)
{
	TMatrix ret;
